...
// Путь относительно Web.Api проекта: ../tempRep/.env
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Version = "v1",
        Title = "NimbusClone API",
        Description = """
            NimbusClone - Multi-tenant Project Management System API
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "NimbusClone API v1");
        options.RoutePrefix = "swagger"; // Swagger UI доступен по /swagger
        options.DocumentTitle = "NimbusClone API Documentation";
